...
public class HTTPUtilities {
	...
	/*
	* Consome uma linha de texto, terminada por CRLF, do canal de entrada dado, e retorna-a como uma String.
	*/
	 ...
	 * Keep-alive", devolve [0]->"Connection"; [1]->"Keep-alive" Caso o header nao
	 ...
	 * associando a cada elemento do form o seu valor. Nota: um objecto Properties,
	 * Ž um dicionario que guarda pares (chave, valor), que a chave Ž do tipo
	 * String.
	 */
