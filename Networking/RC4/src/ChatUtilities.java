...
public class ChatUtilities {
	private static final byte[] errorPage = ("<HTML><BODY>Not Found	</BODY></HTML>").getBytes();
	...
	private static final String formPageMiddle = "\">"+ "<input name=	\"messageText\" type=\"text\" style=\"width:100\"><br>"
