...
// parameter; community=nome&local=true|false
public class ListEventsServlet extends HttpServlet
{
	private static final long serialVersionUID = 3228464695132000588L;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			session.setAttribute( FZConstants.ATTRIB_QUERY, "");
			...
			List<EventInfo> events = proc.listEvents( com, ! Boolean.parseBoolean( global));
