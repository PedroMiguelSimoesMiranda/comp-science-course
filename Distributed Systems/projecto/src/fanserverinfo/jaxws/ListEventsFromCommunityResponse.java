...
@XmlRootElement(name = "listEventsFromCommunityResponse", namespace = "http://fanserverinfo/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "listEventsFromCommunityResponse", namespace = "http://fanserverinfo/")
