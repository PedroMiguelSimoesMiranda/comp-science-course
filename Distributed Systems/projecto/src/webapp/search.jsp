...
<form method="get" action="/SearchServlet" name="query">
...
<tr>
<td  style="text-align: right;">Global query: </td><td  style="text-align: left;">
<%
	if( global) {
%>
...
<% }%>
      ...
      <tr>
        <td colspan="2" style="width: 50%; text-align: center;"><center><button type="submit" value="Search" name="query">Search</button></center></td>
      </tr>
    </tbody>
  </table>
