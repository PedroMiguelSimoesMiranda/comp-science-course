...
String[] imports = proc.listResourceImports();
%>
...
<a href="event.jsp">Back to event</a></td>
...
%>
<p>Search new resource for importing :</p>
<form method="get" action="/ImportResourceServlet" name="query">
  <table style="text-align: left;" border="0" cellpadding="2" cellspacing="2">
    <tbody>
     ...
     <tr> 
      ...
      <tr>
        <td colspan="2" style="width: 50%; text-align: center;"><center><button type="submit" value="Import" name="query">Search resource</button></center></td>
      </tr>
    </tbody>
  </table>
